...
| 39 | 腰痛で眠れない——夜に試したい整理のしかた | E | **フェーズ3**。`drafts/sleep/draft_blog_39_low_back_pain_sleep.md` |
| 40 | 膝・股関節の痛みと睡眠の悪循環をどう断つか | E | **フェーズ3**。`drafts/sleep/draft_blog_40_hip_knee_pain_sleep.md` |
| 41 | 手術後「夜だけ痛くて眠れない」ときの考え方 | E | **フェーズ3**。`drafts/sleep/draft_blog_41_postop_night_pain_sleep.md` |
| 42 | スポーツ整形の文脈で見る「睡眠＝回復」 | E | **フェーズ3**。`drafts/sleep/draft_blog_42_sports_sleep_recovery.md` |
| 43 | 睡眠はケガのリスクや治癒とどう関わるか | E | **フェーズ3**。`drafts/sleep/draft_blog_43_injury_healing_sleep.md` |
| 44 | 痛みの強さと睡眠の質：説明のコツ（患者対話） | E | **フェーズ3**。`drafts/sleep/draft_blog_44_pain_sleep_patient_talk.md` |
| 45 | ギプス・装具装着中の睡眠の工夫 | E | **フェーズ3**。`drafts/sleep/draft_blog_45_cast_brace_sleep.md` |
| 46 | ロコモティブシンドロームと睡眠（いま知りたい要点） | E | **フェーズ3**。`drafts/sleep/draft_blog_46_locomotive_syndrome_sleep.md` |
| 47 | 慢性痛の多角的ケアの一翼としての睡眠医療 | E | **フェーズ3**。`drafts/sleep/draft_blog_47_multidisciplinary_chronic_pain_sleep.md` |
| 48 | ペインクリニックと睡眠：すみ分けのイメージ | B+E | **フェーズ3**。`drafts/sleep/draft_blog_48_pain_clinic_sleep_boundary.md` |
| 49 | 整形外科の問診で「眠り」を聞く意味 | D+E | **フェーズ3**。`drafts/sleep/draft_blog_49_orthopedic_sleep_history.md` |
| 50 | 身体寄りのリラクゼーション入門——痛みとも相性よい理由 | A+E | **フェーズ3**。`drafts/sleep/draft_blog_50_body_relaxation_sleep_pain.md`（不眠一般にも使えるならフェーズ2で織り込み可） |
...
更新日：2026-05-09（**#39〜50** 整形外科×睡眠の下書きを `drafts/sleep/` に追加）
