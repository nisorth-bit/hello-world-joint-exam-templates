...
Edinger ら（2021）の AASM ガイドラインでは、CBT-I を構成する要素のひとつとしてリラクゼーション法（呼吸法・PMR・イメージ法など）が挙げられています（※1）。単独ではなく、刺激統御（→ #6）・睡眠制限（→ #8）・認知再構成（→ #22）と組み合わせることで効果が高まるとされています。
...
- 睡眠のための「道具」に依存しすぎると、「ないと眠れない」につながりやすい（→ #22）
...
| ギプス・装具装着中（→ #45） | 固定部位を動かさず、他の部位の弛緩を行う |
| 腰痛・股関節痛（→ #39・#40） | 姿勢の確認。仰臥位が痛い場合は側臥位で行う |
| 急性炎症期 | まず主治医の鎮痛計画を優先 |
